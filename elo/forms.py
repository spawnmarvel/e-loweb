...
class InputSearch(forms.Form):
    ch = ( ("text contains", "text contains"), ("hook", "hook"), ("title is", "title is"), ("word frequency high", "word frequency high"), ("multiple words separated by comma", "multiple words separated by comma"))
